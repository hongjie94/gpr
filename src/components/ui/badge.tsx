  ...
  "inline-flex items-center rounded-md border border-slate-200 px-2.5 py-0.5 text-xs font-semibold transition-colors focus:outline-none focus:ring-2 focus:ring-slate-950 focus:ring-offset-2 dark:border-slate-800 dark:focus:ring-slate-300",
  {
    variants: {
      variant: {
        ...
        outline: "text-slate-950 dark:text-slate-50 dark:border-[#E7CCA3] relative z-10",
        gold: "border-transparent font-semibold border-none shadow",

        winner: "border-transparent font-semibold border-none bg-green-400 text-slate-50 shadow",
        loser: "border-transparent font-semibold border-none bg-red-400 text-slate-50 shadow",
