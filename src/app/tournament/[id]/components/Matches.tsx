        ...
        >
          ...
          <div className="flex flex-col lg:flex-row justify-center gap-4 items-center">
            {match.state === "completed" ? (
                      ...
                      <div className="mr-7">
                        ...
                        {team.result.outcome && (
                          <Badge
                            className="ml-2"
                            variant={
                              team.result.outcome === "win" ? "winner" : "loser"
                            }
                          >
                            {team.result.outcome}
                          </Badge>
                        ...
                        {match.games.length === 1 && <p> Side: {team.side}</p>}
              ...
              <p className="text-muted text-center">Team Match Not Started</p>
            )}
          </div>
        </div>
      ))}
