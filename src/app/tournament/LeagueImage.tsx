...
const LeagueImage = ({ id }: { id: string }) => {
  ...
  if (loading)
    return (
      <Skeleton className="min-h-[80px] mt-4 absolute top-2 right-5 p-4 flex flex-col items-end">
        <Skeleton className="h-[30px] w-[40px] mr-2 p-2 flex items-center justify-center"></Skeleton>
